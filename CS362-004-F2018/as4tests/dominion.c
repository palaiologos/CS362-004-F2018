...
//-------------------------------------------------------
// Custom card functions for assignment 2 below. --------
//-------------------------------------------------------
int adventurer_card(struct gameState *state)
{
  ...
  while(drawntreasure<2){
    ...
    if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold) {
      drawntreasure++; // BUG 1: decrement instead of increment.
    }
    else
    {
...
int smithy_card(struct gameState *state, int handPos)
{
  ...
  for (i = 0; i < 3; i++)
  {
    discardCard(handPos, currentPlayer, state, 0); // BUG 2: discard instead of draw.
  }
...
{
  int currentPlayer = whoseTurn(state) ; // BUG 3: Gives the other player a card.
  //+1 Card
  drawCard(currentPlayer, state);
...
// Steward card.
int steward_card(struct gameState *state, int choice1, int choice2, int choice3, int handPos)
{
  int currentPlayer = whoseTurn(state);
...
int council_room_card(struct gameState *state, int handPos)
{
  ...
  //+1 Buy
  state->numBuys--; // BUG 4: Decrements the number of buys instead of adding.
...
//-------------------------------------------------------
// End of Custom card functions for assignment 2 --------
//-------------------------------------------------------
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case great_hall:
      return great_hall_card(state, handPos);
    ...
    case steward:
      return steward_card(state, handPos, choice1, choice2, choice3);
